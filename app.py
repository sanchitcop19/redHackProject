...
def determine_earthquake():
    ...
    response = requests.get("https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=1980-01-01&endtime=2000-01-02&maxlatitude={}&minlatitude={}&maxlongitude={}&minlongitude={}&minmagnitude=3".format(
        max_latitude, min_latitude, max_longitude, min_longitude))
    print("https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=1980-01-01&endtime=2000-01-02&maxlatitude={}&minlatitude={}&maxlongitude={}&minlongitude={}&minmagnitude=3".format(
        max_latitude, min_latitude, max_longitude, min_longitude))
